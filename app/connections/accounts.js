...
if (process.env.NODE_ENV !== 'test') {
  ...
  accounts_connection.on(
    'error',
    console.error.bind(console, 'MongoDB account database connection error:')
  )
  ...
  accounts_connection.on(
    'error',
    console.error.bind(console, 'MongoDB test database connection error:')
  )
  accounts_connection.once('open', function () {
